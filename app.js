...
const b=$("#langBtn");if(b)b.textContent=lang==="en"?"EN":lang==="ar"?"ع":"FR"; localStorage.setItem("revaLang",lang); window.dispatchEvent(new CustomEvent("reva:languagechange",{detail:{lang}}));
